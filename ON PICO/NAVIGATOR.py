...
class Navigator:
    ...
    def __init__ (self):
        ...
        self.dirc_paths = {'locA': {'dep1': [2, 2, 3], 'dep2': [4, 3]}, 
                           'locB': {'dep1': [2, 3, 3], 'dep2': [4, 4, 3, 3]}, 
                           'locC': {'dep1': [3, 2, 2, 3, 3], 'dep2': [3, 4, 3, 3]}, 
                           'locD': {'dep1': [2, 3, 3, 3], 'dep2': [4, 4, 3, 3, 3]}, 
                           'start': {'locA': [1, 4, 1]}, 
        ...
        self.node_paths = {'locA': {'dep1': ['f', 'g', 'h', 'dep1'], 'dep2': ['f', 'e', 'dep2']}, 
                           'locB': {'dep1': ['j', 'i', 'h', 'dep1'], 'dep2': ['j', 'k', 'l', 'e', 'dep2']}, 
                           'locC': {'dep1': ['q', 'k', 'j', 'i', 'h', 'dep1'], 'dep2': ['q', 'k', 'l', 'e', 'dep2']}, 
                           'locD': {'dep1': ['o', 'p', 'i', 'h', 'dep1'], 'dep2': ['o', 'n', 'm', 'l', 'e', 'dep2']}, 
